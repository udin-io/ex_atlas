defmodule Atlas.Fly.Logs.StreamerTest do
  use ExUnit.Case, async: false

  alias Atlas.Fly.Dispatcher
  alias Atlas.Fly.Logs.{LogEntry, Streamer, StreamerSupervisor}
  ...
  describe "initial fetch and broadcasting" do
    test "fetches initial logs on start and dispatches via the registry" do
      ...
      assert_receive {:atlas_fly_logs, ^app_name, received}, 1_000
    ...
    test "does not broadcast when no entries returned" do
      ...
      assert_receive :fetch_called, 1_000
      refute_receive {:atlas_fly_logs, _, _}, 200
    end
  end
