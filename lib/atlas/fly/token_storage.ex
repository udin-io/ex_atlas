defmodule Atlas.Fly.TokenStorage do
  @moduledoc """
  Behaviour for durable Fly token storage.

  `Atlas.Fly.Tokens.Server` uses a `TokenStorage` implementation to persist
  tokens across VM restarts. The default implementation is
  `Atlas.Fly.TokenStorage.Dets`, a zero-config DETS-backed table. Hosts can
