defmodule AtlasWeb.Router do
  ...
  scope "/", AtlasWeb do
    ...
    auth_routes AuthController, Atlas.Accounts.User, path: "/auth"
    ...
    confirm_route Atlas.Accounts.User, :confirm_new_user,
      auth_routes_prefix: "/auth",
      overrides: [AtlasWeb.AuthOverrides, Elixir.AshAuthentication.Phoenix.Overrides.DaisyUI]

    # Remove this if you do not use the magic link strategy.
    magic_sign_in_route(Atlas.Accounts.User, :magic_link,
      auth_routes_prefix: "/auth",
      overrides: [AtlasWeb.AuthOverrides, Elixir.AshAuthentication.Phoenix.Overrides.DaisyUI]
    )
  end
